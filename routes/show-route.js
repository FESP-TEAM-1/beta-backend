...
router.delete("/show/like-delete", userAuthenticate, showController.deleteLike);
router.delete("/show/review-delete", userAuthenticate, showController.deleteReview);
